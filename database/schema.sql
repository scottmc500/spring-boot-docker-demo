...
CREATE TABLE `course` (
  ...
  CONSTRAINT `course_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-09-01 19:57:01
